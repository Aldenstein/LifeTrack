        ...
        <div className="media-right">
          ...
          <div className="compte-card__actions">
            <div className="buttons are-small">
              <button className="button compte-card__btn" onClick={e => { e.stopPropagation(); onClick(account.id) }} title="Voir">✏️</button>
              <button className="button compte-card__btn compte-card__btn--danger" onClick={e => { e.stopPropagation(); onDelete(account.id) }} title="Supprimer">🗑️</button>
            </div>
          </div>
        </div>
      </div>
